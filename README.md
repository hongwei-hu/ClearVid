...
```powershell
clearvid run samples\480P_2000K_306841291pigmask.mp4 --target-profile fhd --backend realesrgan --preview-seconds 1 --output outputs\sample_fhd_realesrgan_codeformer_preview.mp4
```
...
```powershell
clearvid run samples\480P_2000K_306841291pigmask.mp4 --target-profile fhd --backend realesrgan --preview-seconds 2 --output outputs\sample_fhd_realesrgan_preview.mp4
```
