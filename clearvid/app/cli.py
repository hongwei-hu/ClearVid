...
def run(
    ...
    temporal_stabilize_enabled: bool = typer.Option(False, help="Reduce frame-to-frame flicker with optical-flow blending (slow)"),
    temporal_stabilize_strength: float = typer.Option(0.6, min=0.0, max=1.0, help="Temporal flicker reduction strength"),
